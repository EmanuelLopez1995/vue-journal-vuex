<template>
  <div class="entry-container mb-3 pointer p-2" @click="$router.push({name: 'entry', params: {id: 10}})">
    ...
    <div class="entry-description">
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repellendus amet enim voluptatum omnis eligendi, modi doloremque animi voluptatem tempora illo. Aspernatur laboriosam autem ullam neque debitis eum ab doloremque vero.
    </div>
  </div>
</template>
